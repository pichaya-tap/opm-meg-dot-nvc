...
This repository contains the implementation of a symmetric fusion pipeline for simultaneously acquired OPM-MEG and high-density DOT data. This pipeline integrates variable physical sensitivities to identify a unified, localized neurovascular unit on the cortical surface.
