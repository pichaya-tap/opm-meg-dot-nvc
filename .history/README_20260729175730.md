...
This repository contains the official implementation of a symmetric fusion pipeline for simultaneously acquired OPM-MEG and high-density DOT data. Utilizing the multimodal Source Power Comodulation (mSPoC) framework, this pipeline reconciles disparate physical sensitivities to identify a unified, localized neurovascular unit on the cortical surface.
📌 Abstract
